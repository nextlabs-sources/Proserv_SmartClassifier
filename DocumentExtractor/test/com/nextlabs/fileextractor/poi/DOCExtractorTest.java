...
import com.nextlabs.smartclassifier.poi.DOCExtractor;
...
public class DOCExtractorTest {
	...
	private final Logger logger = LoggerFactory.getLogger(DOCExtractorTest.class);
	...
	private static DocumentContent extractFile(String absoluteFilePath) throws Exception {
		DocumentExtractor extractor = new DOCExtractor(absoluteFilePath);
	...
	public static void init() throws Exception {
		...
		// Meta-data - String 
        File file1 = new File("test/res/One.doc");
        ...
        File file2 = new File("test/res/Two.doc");
        ...
        File file3 = new File("test/res/Three.doc");
        ...
        File file4 = new File("test/res/Four.doc");
    ...
    public void testDocHeader1() {
        logger.info("Checking DOC One header.");
    ...
    public void testDocContent1() {
        logger.info("Checking DOC One content.");
    ...
    public void testDocFooter1() {
        logger.info("Checking DOC One footer.");
    ...
    public void testDocMetadata1() {    	   	    
        logger.info("Checking DOC One metadata.");
    ...
    public void testDocHeader2() {
        logger.info("Checking DOC Two header.");
    ...
    public void testDocContent2() {
        logger.info("Checking DOC Two content.");
    ...
    public void testDocFooter2() {
        logger.info("Checking DOC Two footer.");
    ...
    public void testDocMetadata2() {    	   	    
        logger.info("Checking DOC Two metadata.");
    ...
    public void testDocHeader3() {
        logger.info("Checking DOC Three header.");
    ...
    public void testDocContent3() {
        logger.info("Checking DOC Three content.");
    ...
    public void testDocFooter3() {
        logger.info("Checking DOC Three footer.");
        assertEquals("OFFICIAL SENSITIVE", documentContent3.getDocumentFooter());
        logger.info("Done");
    }   
    
    @Test
    public void testDocMetadata3() throws ParseException {    	   	    
    ...
    public void testDocHeader4() {
        logger.info("Checking DOC Four header.");
    ...
    public void testDocContent4() {
        logger.info("Checking DOC Four content.");
    ...
    public void testDocFooter4() {
        logger.info("Checking DOC Four footer.");
    ...
    public void testDocMetadata4() {    	  	    	
        logger.info("Checking DOC Four metadata.");   
