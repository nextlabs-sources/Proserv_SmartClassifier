@echo off
set SERVICE_NAME=Smart Classifier File Watcher
set HOME_DIR=%~dp0..
...
set PR_JVMOPTIONS=-Dconfig.folder=%HOME_DIR%\conf\;-Dcom.sun.management.jmxremote.port=8804;-Dcom.sun.management.jmxremote.ssl=false;-Dcom.sun.management.jmxremote.authenticate=false;-Dlog4j2.configurationFile=%HOME_DIR%\conf\log4j2.xml
...
"%PR_INSTALL%" //IS/"%SERVICE_NAME%" ^
  ...
  --Description="Runs the Watcher component of Smart Classifier" ^
