@echo off
set SERVICE_NAME=Smart Classifier Rule Engine
set HOME_DIR=%~dp0..
...
set PR_CLASSPATH=%LIB_HOME%\*;%HOME_DIR%\conf;%HOME_DIR%\plugins\*;%HOME_DIR%\nextlabs-rule-engine.jar
...
set PR_JVMOPTIONS=-Dconfig.folder=%HOME_DIR%\conf\;-Dplugins.folder=%HOME_DIR%\plugins\;-Dlog4j2.configurationFile=%HOME_DIR%\conf\log4j2.xml
...
"%PR_INSTALL%" //IS/"%SERVICE_NAME%" ^
  ...
  --Description="Runs the Rule Engine component of Smart Classifier" ^
