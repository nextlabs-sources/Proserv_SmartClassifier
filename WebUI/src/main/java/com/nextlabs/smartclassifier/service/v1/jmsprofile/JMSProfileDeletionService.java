...
public class JMSProfileDeletionService 
		extends Service {
	
	public JMSProfileDeletionService(ServletContext servletContext) {
		super(servletContext);
	}
	
	public JMSProfileDeletionService(ServletContext servletContext, ServletRequest servletRequest, ServletResponse servletResponse) {
		super(servletContext, servletRequest, servletResponse);
	}
	
	public ServiceResponse deleteJMSProfile(DeletionRequest deletionRequest) {
		...
		try {
			...
			new JMSProfileManager(getSessionFactory(), session).deleteJMSProfile(((JMSProfileDTO)deletionRequest.getData()).getEntity());
			...
			response.setMessage(MessageUtil.getMessage("no.entity.found.delete", "JMS profile"));
