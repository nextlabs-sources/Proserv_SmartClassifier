...
public class UserDeletionService 
	...
	public UserDeletionService(ServletContext servletContext) {
		super(servletContext);
	}
	
	public UserDeletionService(ServletContext servletContext, ServletRequest servletRequest, ServletResponse servletResponse) {
		super(servletContext, servletRequest, servletResponse);
	}
	
	public ServiceResponse deleteUser(DeletionRequest deletionRequest) {
		...
		try {
			...
			new UserManager(getSessionFactory(), session).deleteUser(((UserDTO)deletionRequest.getData()).getEntity());
