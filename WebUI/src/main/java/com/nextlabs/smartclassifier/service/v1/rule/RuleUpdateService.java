...
public class RuleUpdateService 
	...
	public RuleUpdateService(ServletContext servletContext) {
		super(servletContext);
	}
	
	public RuleUpdateService(ServletContext servletContext, ServletRequest servletRequest, ServletResponse servletResponse) {
		super(servletContext, servletRequest, servletResponse);
	}
	
	public ServiceResponse updateRule(UpdateRequest updateRequest) {
		...
		try {
			...
			new RuleManager(getSessionFactory(), session).updateRule(((RuleDTO)updateRequest.getData()).getEntity());
