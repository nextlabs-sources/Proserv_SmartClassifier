...
public class ExecutionWindowSetUpdateService extends Service {

  public ExecutionWindowSetUpdateService(ServletContext servletContext) {
    super(servletContext);
  }

  public ExecutionWindowSetUpdateService(
  ...
  public ServiceResponse updateExecutionWindowSet(UpdateRequest updateRequest) {
    ...
    try {
      ...
      new ExecutionWindowSetManager(getSessionFactory(), session)
          .updateExecutionWindowSet(((ExecutionWindowSetDTO) updateRequest.getData()).getEntity());
      ...
      response.setMessage(MessageUtil.getMessage("no.entity.found.modify", "execution window set"));
