...
public class ExecutionWindowSetDeletionService extends Service {

  public ExecutionWindowSetDeletionService(ServletContext servletContext) {
    super(servletContext);
  }

  public ExecutionWindowSetDeletionService(
  ...
  public ServiceResponse deleteExecutionWindowSet(DeletionRequest deletionRequest) {
    ...
    try {
      ...
      new ExecutionWindowSetManager(getSessionFactory(), session)
          .deleteExecutionWindowSet(
              ((ExecutionWindowSetDTO) deletionRequest.getData()).getEntity());
      ...
      response.setMessage(MessageUtil.getMessage("no.entity.found.delete", "execution window set"));
