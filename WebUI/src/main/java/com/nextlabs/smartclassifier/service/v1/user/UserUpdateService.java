...
public class UserUpdateService 
	...
	public UserUpdateService(ServletContext servletContext) {
		super(servletContext);
	}
	
	public UserUpdateService(ServletContext servletContext, ServletRequest servletRequest, ServletResponse servletResponse) {
		super(servletContext, servletRequest, servletResponse);
	}
	
	public ServiceResponse updateUser(UpdateRequest updateRequest) {
		...
		try {
			...
			new UserManager(getSessionFactory(), session).updateUser(((UserDTO)updateRequest.getData()).getEntity());
			...
			response.setMessage(MessageUtil.getMessage("no.entity.found.modify", "User"));
