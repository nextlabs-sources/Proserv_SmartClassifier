...
public class ActionPluginUpdateService 
		extends Service {
	
	public ActionPluginUpdateService(ServletContext servletContext) {
		super(servletContext);
	}
	
	public ActionPluginUpdateService(ServletContext servletContext, ServletRequest servletRequest, ServletResponse servletResponse) {
		super(servletContext, servletRequest, servletResponse);
	}
	
	public ServiceResponse updateActionPluginFixedParameter(UpdateRequest updateRequest) {
		...
		try {
			...
			new ActionPluginManager(getSessionFactory(), session).updateActionPluginFixedParameter(((ActionPluginDTO)updateRequest.getData()).getEntity());
