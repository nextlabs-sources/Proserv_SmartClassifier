...
import com.nextlabs.smartclassifier.dto.v1.ActionDTO;
import com.nextlabs.smartclassifier.dto.v1.ActionParamDTO;
import com.nextlabs.smartclassifier.dto.v1.CriteriaDTO;
import com.nextlabs.smartclassifier.dto.v1.CriteriaGroupDTO;
import com.nextlabs.smartclassifier.dto.v1.KeyValueDTO;
...
public class RuleCreationValidator {

    private static final Logger logger = LogManager.getLogger(RuleCreationValidator.class);
    ...
    public static Validation validate(CreationRequest request) throws Exception {
        ...
        if (ruleDTO.getRuleEngine() == null
            ...
            validation.setErrorMessage(
                    MessageUtil.getMessage("invalid.input.field.blank", "Rule engine"));
        ...
        if (StringUtils.isBlank(ruleDTO.getRepositoryType())) {
            ...
            validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
            validation.setErrorMessage(
                    MessageUtil.getMessage("invalid.input.field.blank", "Repository Type"));
                ...
                if (criteriaGroupDTO.getCriterias() != null) {
                    for (CriteriaDTO criteriaDTO : criteriaGroupDTO.getCriterias()) {
                        ...
                        if (StringUtils.isBlank(criteriaDTO.getDataSection())) {
                            ...
                            validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
                            validation.setErrorMessage(
                                    MessageUtil.getMessage("invalid.input.field.blank", "Data section"));
                        ...
                        if (StringUtils.isBlank(criteriaDTO.getMatchingCondition())) {
                            ...
                            validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
                            validation.setErrorMessage(
                                    MessageUtil.getMessage("invalid.input.field.blank", "Matching condition"));
                        ...
                        if (DataSection.METADATA.getCode().equals(criteriaDTO.getDataSection())
                            ...
                            validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
                            validation.setErrorMessage(
                                    MessageUtil.getMessage("invalid.input.field.blank", "Metadata field name"));
                        ...
                        if (StringUtils.isBlank(criteriaDTO.getValue())) {
                            ...
                            validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
                            validation.setErrorMessage(
                                    MessageUtil.getMessage("invalid.input.field.blank", "Criteria value"));
                        ...
                        if (MetadataMatchingCondition.NUM_EQUALS.getCode().equals(criteriaDTO.getMatchingCondition())
                            ...
                            try {
                                ...
                                validation.setErrorCode(
                                        MessageUtil.getMessage("invalid.input.field.maxvalue.code"));
                                validation.setErrorMessage(
                                        MessageUtil.getMessage(
                                                "invalid.input.field.maxvalue", criteriaDTO.getField(), Integer.MAX_VALUE));
        ...
        if (ruleDTO.getActions() == null || ruleDTO.getActions().size() == 0) {
            ...
            for (ActionDTO actionDTO : ruleDTO.getActions()) {
                if (actionDTO.getActionPlugin() == null || actionDTO.getActionPlugin().getId() == 0) {
                    validation.isValid(false);
                    validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.zero.code"));
                    validation.setErrorMessage(
                            MessageUtil.getMessage("invalid.input.field.zero.code", "ActionPluginID"));
                ...
                if (actionDTO.getActionParams() != null) {
                    for (ActionParamDTO actionParamDTO : actionDTO.getActionParams()) {
                        if (StringUtils.isBlank(actionParamDTO.getIdentifier())) {
                            ...
                            validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
                            validation.setErrorMessage(
                                    MessageUtil.getMessage("invalid.input.field.blank", "Identifier"));
                        ...
                        for (KeyValueDTO keyValue : actionParamDTO.getValues()) {
                            if (StringUtils.isBlank(keyValue.getValue())) {
                                ...
                                validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
                                validation.setErrorMessage(
                                        MessageUtil.getMessage("invalid.input.field.blank", "Value"));
        ...
        if (ruleDTO.getExecutionFrequency() != null) {
            ...
            if (ScheduleType.WEEKLY.getCode().equalsIgnoreCase(ruleDTO.getScheduleType())) {
                if (ruleDTO.getExecutionFrequency().getDayOfWeek() == null
                    ...
                    validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
                    validation.setErrorMessage(
                            MessageUtil.getMessage("invalid.input.field.blank", "Day of week"));
            ...
            if (ScheduleType.MONTHLY.getCode().equalsIgnoreCase(ruleDTO.getScheduleType())) {
                if (ruleDTO.getExecutionFrequency().getDayOfMonth() == null
                    ...
                    validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
                    validation.setErrorMessage(
                            MessageUtil.getMessage("invalid.input.field.blank", "Day of month"));
            ...
            validation.setErrorCode(MessageUtil.getMessage("invalid.input.field.blank.code"));
            validation.setErrorMessage(
                    MessageUtil.getMessage("invalid.input.field.blank", "Execution frequency"));
