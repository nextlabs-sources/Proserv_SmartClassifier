...
set SOLR_JAVA_HOME=%SC_JAVA_HOME%

REM Increase Java Min/Max Heap as needed to support your indexing / query needs
set SOLR_JAVA_MEM=-Xms512m -Xmx8192m
...
set SOLR_OPTS=%SOLR_OPTS% -Dsolr.jetty.truststore.password=changeit -Dsolr.jetty.keystore.password=changeit
set SOLR_OPTS=%SOLR_OPTS% -Djavax.net.ssl.trustStorePassword=changeit -Djavax.net.ssl.keyStorePassword=changeit
...
set SOLR_SSL_KEY_STORE=..\server\etc\key.jks
set SOLR_SSL_KEY_STORE_PASSWORD=changeit
set SOLR_SSL_TRUST_STORE=..\..\Java11\lib\security\cacerts
set SOLR_SSL_TRUST_STORE_PASSWORD=changeit
